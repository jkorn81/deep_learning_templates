...
(1) To downlaod course resources GitHub, please clone the repo and perform the following steps from [link]:

(2) Install Python <=3.7 (https://www.python.org/downloads/release/python-3710/) and Anaconda (https://docs.anaconda.com/anaconda/install/). 

(3) Open the Anaconda terminal or local machines terminal. 
